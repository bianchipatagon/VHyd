...
corr_ver=pd.concat([ver2, ver1], axis=1, keys=['ver2', 'ver1']).corr(method='spearman').loc['ver1', 'ver2']
...
corr_inv=pd.concat([inv2, inv1], axis=1, keys=['inv2', 'inv1']).corr(method='spearman').loc['inv1', 'inv2']
